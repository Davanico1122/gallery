window.onload = () => {
  gsap.set('#scrollDist', {
    ...
    onComplete: () => {
      ...
      gsap.set('#app img', {
        position: 'absolute',
        attr: { id: (i, t) => { initImg(i, t); return 'img' + i; } }
      });
      ...
      .fromTo('#txt1 path', { opacity: 0 }, { opacity: 1, stagger: 0.05, ease: 'power1.in' }, 0)
  ...
  function showDetail(t) {
    gsap.timeline()
      ...
      .set('#detailImg', { background: 'url(' + t.src + ') center no-repeat', backgroundSize: 'contain' }, 0)
